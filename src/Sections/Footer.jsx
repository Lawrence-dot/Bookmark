...
function Footer() {
  ...
  return (
    <div className="flex footer">
      <div className="footerbdy container-d w-full flex">
        ...
        <div className="navlinks txt-white hidden sm:block mr-auto">
        ...
        <div className="navlinks flex hidden sm:flex ml-auto">
          <span>
            <FaFacebook />{" "}
          </span>
